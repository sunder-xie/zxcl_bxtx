(function($, window, document, undefined) {
    ...
    function buildWalkthrough() {
        ...
        if (step.popup.type !== "modal" && step.popup.type !== "nohighlight") {
            ...
            $("<div>").addClass("overlay-hole").width(targetElement.outerWidth()).css({
                position: "absolute",
                top: targetElement.offset().top - 20,
                left: targetElement.offset().left - 20,
                "z-index": 999998,
                "box-shadow": "0 0 1px 1000px rgba(0, 0, 0, 0.6)"
            }).append($("<div>").css({
                position: "absolute",
                top: 0,
                bottom: 0,
    ...
    function showTooltip() {
        ...
        $jpwTooltip.html("").css({
            ...
            id: "tooltipWrapper",
            style: "width: 150px; transform: none; filter: none;"
        })).appendTo($jpWalkthrough);
        $jpWalkthrough.appendTo("body").show();
        $("#tooltipWrapper").css(textRotation);
        $("#tooltipInner").append(getContent(step)).show();
        $jpwTooltip.append('<span class="' + step.popup.position + '" style="left:65px;"">&nbsp;</span>');
        ...
        case "right":
            ...
            break;
        case "bottom":
            top = overlayHoleTop + overlayHoleHeight + parseInt(step.popup.offsetVertical, 10) + 110;
            left = overlayHoleLeft + overlayHoleWidth / 2 - $jpwTooltip.width() / 2 - 5 + parseInt(step.popup.offsetHorizontal, 10)+110;
            arrowLeft = $jpwTooltip.width() / 2 - arrow + parseInt(step.popup.offsetArrowHorizontal, 10);
            arrowTop = step.popup.offsetArrowVertical ? parseInt(step.popup.offsetArrowVertical, 10) : "";
            break;
        case "left":
