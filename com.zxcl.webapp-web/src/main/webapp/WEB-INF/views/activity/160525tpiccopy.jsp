...
<body>
	...
	<div class="content-main"  style="padding-top:10px;"><%--
		...
		<div class="content-activity" align="center">
			...
			<p class="p1">一、活动时间：2016年5月26日-6月15日</p>
			<p class="">二、活动对象：“保行天下”车险交易平台注册用户，公司内勤除外</p>
			<p class="">三、活动内容：使用交易平台每成功出单一张天平汽车商业保险，即可获得重磅“红包”一份。</p>
			<p class="">四、获奖方式：天平汽车商业险保单出单后，点击保行天下系统投保界面的方案内容，即可获得一份重磅“红包”；用户点击红包打开后，显示相应奖励金额，并将金额直接放入用户的保行天下电子钱包（为激活金额），可提现。</p>
			<p class="">五、在线出单立即获得红包、可提现、可累计领取！</p>
